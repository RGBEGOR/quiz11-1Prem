...
[
	...
	new Question("Пару слов к учатникам команд, в каком году Узбекистан обрел независимость и по какой причине?", 
	[
		new Answer("поехали дальше", 1)
	]),
	new Question("Кто стал первый президентом Республики Узбекистан и какая форма правления у нас в Узбекистане?", 
	[
		new Answer("далее", 1)
	]),
	new Question("Формирование института президентства основывается на трех важных состовляющих? Что являеться основой?", 
	[
		new Answer("далее", 1)
	]),
	new Question("Попробуйте объяснить своими словами, как Вы понимаете термин - Референдум? ", 
	[
		new Answer("далее", 1),
	]),
	new Question("А что такое - Доктрина и в чем ее значение?", 
	[
		new Answer("далее", 1),
	]),
	new Question("А теперь вопрос по Всемирной истории; Как Вы понимаете термин однополярный Мир и двуполярный Мир?", 
	[
		new Answer("далее", 1),
	]),
	new Question("А попробуйте перечислить страны обладающие ядерным оружием на сегодняшний день?", 
	[
		new Answer("далее", 1),
	]),
	new Question("Как Вы думаете что являеться по Вашему мнению самой опасной угрозой человества и почему?", 
	[
		new Answer("далее", 1),
	]),
	new Question("Когда Вы слышите -Олий Мажлис- что сразу приходит на ум и  что это такое? ", 
	[
		new Answer("далее", 1),
	]),
	new Question(" Вопрос ко всем группам; Cмотрите ли Вы новости и новостные ленты о том что просходит в Мире? ", 
	[
		new Answer("далее", 1),
	]),
